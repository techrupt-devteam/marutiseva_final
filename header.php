  ...
  <div class="top-bar-angle">
    <div class="container">
      <div class="row">
        ...
        <!-- Col End -->
        <div class="col-lg-3 col-md-3 col-12 pl-0 text-md-right text-center">
  ...
  <div class="menu-container header-angle"> <a href="https://www.marutiseva.com" class="logo">
    ...
    <div class="menu">
      <ul id="menu" class='menu'>
        ...
        <!-- <li class="dropdown mega-dropdown menu-dropdown-icon"> 
          <a href="#" class="dropdown-toggle" data-toggle="dropdown">Our Product  </a>
          <div class="dropdown-menu mega-dropdown-menu">
            <div class="container">
              <ul class="nav nav-tabs d-flex border-0 justify-content-center" role="tablist">
                <li ><a href="#Hatchbacks" role="tab" data-toggle="tab" class="active"> Hatchbacks</a></li>
                <li><a href="#Sedans" role="tab" data-toggle="tab">Sedans</a></li>
                <li><a href="#Muvs" role="tab" data-toggle="tab"> Muvs/ Suvs</a></li>
                <li><a href="#Vans" role="tab" data-toggle="tab">Vans</a></li>
              </ul>
              
              <div class="tab-content">
                <div class="tab-pane active" id="Hatchbacks">
                  <div class="row justify-content-center">
                    <div class="col-md-3 col-sm-4 col-6"> <a href="alto.php" class="mega-link-with-img"> <img src="assets/images/alto/Alto800_Cerulean_BLue.png"/> <span>Alto</span> </a> </div>
                    <div class="col-md-3 col-sm-4 col-6"> <a href="wagonr.php" class="mega-link-with-img"> <img src="assets/images/wagonr/2-model-BLUE.png"/> <span>Wagon R</span> </a> </div>
                    <div class="col-md-3 col-sm-4 col-6"> <a href="celerio.php" class="mega-link-with-img"> <img src="assets/images/celerio/orange.png"/> <span>Celerio</span> </a> </div>
                    <div class="col-md-3 col-sm-4 col-6"> <a href="celerio-x.php" class="mega-link-with-img"> <img src="assets/images/celerio-x/Prl-Caffein-Brown.png"/> <span>Celerio X</span> </a> </div>
                    <div class="col-md-3 col-sm-4 col-6"> <a href="swift.php" class="mega-link-with-img"> <img src="assets/images/swift/Midnight-Blue.png"/> <span>Swift</span> </a> </div>
                  </div>
                </div>
                <div class="tab-pane" id="Sedans">
                  <div class="row justify-content-center">
                    <div class="col-md-3 col-sm-4 col-6"> <a href="dzire.php" class="mega-link-with-img"> <img src="assets/images/dzire/2-car.png"/> <span>Dzire</span> </a> </div>
                  </div>
                </div>
                <div class="tab-pane" id="Muvs">
                  <div class="row justify-content-center">
                    <div class="col-md-3 col-sm-4 col-6"> <a href="s-presso.php" class="mega-link-with-img"> <img src="assets/images/s-presso/blue.png"/> <span>S-PRESSO</span> </a> </div>
                    <div class="col-md-3 col-sm-4 col-6"> <a href="ertiga.php" class="mega-link-with-img"> <img src="assets/images/ertiga/artic-white.png"/> <span>Ertiga</span> </a> </div>
                    <div class="col-md-3 col-sm-4 col-6"> <a href="vitara-brezza.php" class="mega-link-with-img"> <img src="assets/images/vitara-brezza/2-car.png"/> <span>Vitara Brezza</span> </a> </div>
                  </div>
                </div>
                <div class="tab-pane" id="Vans">
                  <div class="row justify-content-center">
                    <div class="col-md-3 col-sm-4 col-6"> <a href="eeco.php" class="mega-link-with-img"> <img src="assets/images/eeco/2-car.png"/> <span>Eeco</span> </a> </div>
                  </div>
                </div>
              </div>
            </div>
        ...
        <li class="menu-dropdown-icon"><a href="#">Car</a>
          <ul style="display: none;" class="mobile-height-set">
            
            <li><a href="#" style="border-bottom:none"></a>
        		<ul class="submenu">
                <li>
                  <a href="alto.php" class="mega-link-with-img"> <img src="assets/images/alto/Alto800_Cerulean_BLue.png"/> 
                    <span>Alto</span> </a>
                </li>
		         </ul>      
            </li>
            <li><a href="#" style="border-bottom:none"></a>
              <ul class="submenu">
                <li>
                  <a href="wagonr.php" class="mega-link-with-img"> <img src="assets/images/wagonr/2-model-BLUE.png"/> <span>Wagon R</span> </a>
                </li>
		         </ul>  
            </li>
            <li><a href="#" style="border-bottom:none"></a>
              <ul class="submenu">
                <li>
                  <a href="celerio.php" class="mega-link-with-img"> <img src="assets/images/celerio/orange.png"/> <span>Celerio</span> </a> 
                </li>
		         </ul> 
            </li>
            <li><a href="#" style="border-bottom:none"></a>
            <ul class="submenu">
                <li>
                  <a href="celerio-x.php" class="mega-link-with-img"> <img src="assets/images/celerio-x/Prl-Caffein-Brown.png"/> <span>Celerio X</span> </a>
                </li>
		         </ul>
            </li>
            ...
            <ul class="submenu">
                <li>
                  <a href="dzire.php" class="mega-link-with-img"> <img src="assets/images/dzire/2-car.png"/> <span>Dzire</span> </a>
                </li>
             </ul>      
            </li>
            <li>
              <ul class="submennu">
                <li>
                  <a href="s-presso.php" class="mega-link-with-img"> <img src="assets/images/s-presso/blue.png"/> <span>S-PRESSO</span> </a>
                </li>
              </ul>
            </li>
            <li>
              <ul class="submennu">
                <li>
                  <a href="ertiga.php" class="mega-link-with-img"> <img src="assets/images/ertiga/artic-white.png"/> <span>Ertiga</span> </a>
                </li>
              </ul>
            </li>
            <li>
              <ul class="submennu">
                <li>
                  <a href="vitara-brezza.php" class="mega-link-with-img"> <img src="assets/images/vitara-brezza/2-car.png"/> <span>Vitara Brezza</span> </a>
                </li>
              </ul>
            </li>
            <li>
              <ul class="submennu">
                <li>
                  <a href="eeco.php" class="mega-link-with-img"> <img src="assets/images/eeco/2-car.png"/> <span>Eeco</span> </a>
                </li>
              </ul>
            </li>
            <li>
              <ul class="submennu">
                <li>
                  <a href="swift.php" class="mega-link-with-img"> <img src="assets/images/swift/Lucent-OrangeN.png"/> <span>Swift</span> </a>
                </li>
              </ul>
            </li>
