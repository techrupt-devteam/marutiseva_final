  ...
  <div class="footer-top">
    <div class="container">
      <div class="row">
        ...
        <!-- Box 1 end-->
        <div class="col-md-4 footer-box"> <img src="assets/images/icon/phone.svg" width="35"/>
          <div class="footer-box-content">
        ...
        <!-- Box 2 end-->
        <div class="col-md-4 footer-box"> <img src="assets/images/icon/mail.svg" width="35" style="margin-left: 35px;"/>
          <div class="footer-box-content">
