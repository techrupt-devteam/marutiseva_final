    ...
    <div class="outer slick-initialized slick-slider">
      <div class="slick-list draggable">
        <div class="slick-track">
          <div class="row">
            <div class="col-lg-5 col-md-4 col-sm-4 px-0 pr-0 trending-rockerz leftColumn slick-slide slick-current slick-active">
              <div id="demo" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner" style="width: 102.5%;">
                  <div class="carousel-item active">
                    <img src="assets/new-offer/eeco.jpg" alt="New-Offer" class="w-100">
                  </div>
